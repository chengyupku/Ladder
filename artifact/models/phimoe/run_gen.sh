...
python -u ./gen.py --config 3.5b --batch_size 1 --seq_length_q 4096 --seq_length_kv 4096

echo "Running phimoe_3.5b, batch 1, seqlen_q 1, seqlen_kv 8192"
python -u ./gen.py --config 3.5b --batch_size 1 --seq_length_q 1 --seq_length_kv 8192 --is_decode

echo "Running phimoe_3.5b, batch 16, seqlen_q 1, seqlen_kv 8192"
python -u ./gen.py --config 3.5b --batch_size 16 --seq_length_q 1 --seq_length_kv 8192 --is_decode
