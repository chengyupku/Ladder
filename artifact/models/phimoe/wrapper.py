...
from transformers import PhimoeConfig
...
class PhimoeWrapper(nn.Module):
    """
    PhiMoeWrapper wraps a PhimoeModel model and provides a forward method to run the model.

    Args:
        decoder: PhimoeDecoderLayer
    """

    def __init__(self, config: PhimoeConfig, decoder: nn.Module):
        super().__init__()
        self.config = config
