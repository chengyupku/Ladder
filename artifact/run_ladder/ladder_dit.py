...
parser.add_argument('--prefix', type=str, default='dit_XL2')
...
if __name__ == "__main__":
    ...
    model_config = f"{args.prefix}_layer1_n{args.n}_img{args.img}"
    if args.single_attn:
        model_config += "_single_attn"
    elif args.no_attn:
        model_config += "_no_attn"
    path = f"{model_path}/dit/{model_config}/model.onnx"
