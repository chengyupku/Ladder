...
parser.add_argument('--prefix', type=str, default='mamba2_1.3b')
...
if __name__ == "__main__":
    ...
    model_config = f"{args.prefix}_layer1_seq{args.seqlen}_bs{args.batch}"
    if args.single_attn:
        model_config += "_single_attn"
    elif args.no_attn:
        model_config += "_no_attn"
    path = f"{model_path}/mamba2/{model_config}/model.onnx"
